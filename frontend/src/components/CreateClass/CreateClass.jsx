            ...
            >
                <div className="form p-4">
                    ...
                    <div className="p-4 flex flex-col gap-2">
                        <TextField id="filled-basic" value={className} onChange={(e)=>setClassName(e.target.value)} label="Class Name (required)" variant='filled' className='w-[30rem]' />
                        ...
                        <TextField id="filled-basic" value={courseDescription} onChange={(e)=>setCourseDescription(e.target.value)} label="Course Description *" variant='filled' className='w-[30rem]' />
                    </div>
                    <DialogActions>
